...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      mavlinkBridgeUrl: process.env.PUBLIC_MAVLINK_BRIDGE_URL || 'ws://127.0.0.1:8800',
      videoStreamWsUrl: process.env.PUBLIC_VIDEO_STREAM_WS_URL || 'ws://127.0.0.1:4000/api/v1/video-stream/watch',
      stunServer: process.env.PUBLIC_STUN_SERVER || 'stun:stun.l.google.com:19302',
      mapTilerApiKey: process.env.PUBLIC_MAPTILER_API_KEY || '',
    },
  },
  modules: [
    '@nuxt/eslint',
